...
public class RemindExam extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remind_exam);
        alrmTry = (Button)findViewById(R.id.remindEx);
        examDays = (EditText) findViewById(R.id.examDays);
      ...
      /*  dataRef.child(userID).child("Number of Activities").addValueEventListener(new ValueEventListener() {
        ...
        dataRef.child(userID).child("Exams").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        alrmTry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //sendGps();
                exdays = examDays.getText().toString();
                al();
            }
        });
  ...
  /*      ArrayList<PendingIntent> intentArray = new ArrayList<PendingIntent>();
      ...
      //      alarmManager[i].set(AlarmManager.RTC_WAKEUP, 0, pi);
        ...
        for (int i=0; i<actList.size(); i++){
            ...
            Intent intent = new Intent(RemindExam.this, GPSReceiver.class);
    ...
    private void al(){
        ...
        int days = Integer.valueOf(exdays);
        for (int j=0; j<sss.size(); j=j+7){
            Act act = new Act();
            act.setHour(12);
            act.setActName(sss.get(j+5));
        ...
        for (int f = 0; f < cal.length; f++) {
            actNum=actNum-1;
            Intent intent = new Intent(RemindExam.this,
                    ExamReceiver.class);
